package com.sudiyi.apps.cameracheck.util.log;

import android.os.Environment;
import android.util.Log;

import com.sudiyi.apps.cameracheck.Config;
...
public class LogUtils {
    ...
    private static String tag = "CameraCheck";
    private static String dir = null;
    private static final String SAVE_FILE_NAME = "Log";
    ...
    public static void init(boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag) {
        dir = Config.MEDIA_DIRECTORY + File.separator + SAVE_FILE_NAME + File.separator;

        LogUtils.d("logcat save path:" + dir);
    ...
    public static Builder getBuilder() {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            ...
            dir = Config.MEDIA_CACHE_DIRECTORY + File.separator + SAVE_FILE_NAME + File.separator;
        }
        return new Builder();
    }
    ...
    public static class Builder {
        ...
        private String tag = "CameraCheck";
